// Publications — shared by prisma/seed.mjs (full reseed) and
// prisma/ensure-publications.mjs (idempotent create-if-missing on deploy).
const ivrFigures = [
  {
...
export const publications = [
  ...
  },
  {
    ...
    authors: "Bao Tran, Thanh Duc Ngo",
    venue: "ACM MM",
    venueDetail: "ACM MM 2026 · ACM International Conference on Multimedia",
    year: 2026,
    slug: "dialogue-to-evidence-interactive-person-retrieval",
    abstract:
    ...
    highlights: [
      "Reformulates interactive text-based person retrieval as retrieval-state-conditioned evidence acquisition",
      "Grounded discrete concept space: queries, candidate evidence and feedback unified as reusable concept atoms",
      "Redundancy-aware utility selects the most discriminative unresolved concept each round",
      "Language is only the interface — decisions run over structured concept-level evidence, with no extra policy training",
      "Shifts the question budget from frequent head concepts toward informative long-tail concepts",
      "+31.01% R@1 over five rounds on Interactive-PEDES · accepted at ACM MM 2026",
    ].join("\n"),
    figures: JSON.stringify([
      {
        src: "/figures/dialogue-to-evidence-interactive-person-retrieval/fig1-longtail-concepts.png",
        caption:
          "Concept atoms follow a heavy long-tailed corpus distribution, partitioned into head, mid and tail tiers. Frequent head attributes are easy to ask about but weakly discriminative, while the more informative attributes sit in the long tail.",
      },
      {
        src: "/figures/dialogue-to-evidence-interactive-person-retrieval/fig2-concept-selection.png",
        caption:
          "Which concepts get queried across a session: the language-centric baseline (blue) concentrates its questions on a few high-frequency head atoms, whereas the proposed planner (green) shifts the question budget toward more informative mid- and tail concepts.",
      },
      {
        src: "/figures/dialogue-to-evidence-interactive-person-retrieval/fig3-round-gains.png",
        caption:
          "R@1 at interaction round 0 versus round 5, grouped by the frequency tier of the most-queried concept atom. Interaction lifts R@1 across all tiers, with mid-tier concepts — which the planner disproportionately selects — giving the largest gain.",
      },
    ]),
    pdfUrl: "",
    codeUrl: "",
    projectUrl: "",
    image: "/figures/dialogue-to-evidence-interactive-person-retrieval/fig2-concept-selection.png",
    featured: false,
    order: 2,
  },
  {
    title: "When Helpful Text Hurts: Option-Redirecting Bias in Vision–Language Models",
    authors: "Tam Le Thi Thanh, Hoang Tran Van, Thanh Duc Ngo",
    venue: "ACM MM",
    venueDetail: "ACM MM 2026 · ACM International Conference on Multimedia",
    year: 2026,
    slug: "option-redirecting-bias-vlm",
    abstract:
    ...
    highlights: [
      "Identifies \"option-redirecting\" auxiliary text as the most harmful failure mode in tri-modal VQA",
      "Harm is decision-level: question-aligned but image-inconsistent text that favors one distractor",
      "Textual Reliability Ladder — a controlled protocol varying only the auxiliary text along 3 axes",
      "Up to 53.1% accuracy drop across 4 datasets and recent Qwen-VL / InternVL models",
      "Training-free inference-time fix: noise-stability steering (NSS) + dynamic grounding (DG)",
      "Recovers accuracy under misleading text while preserving it under faithful text · accepted at ACM MM 2026",
    ].join("\n"),
    figures: JSON.stringify([
      {
        src: "/figures/option-redirecting-bias-vlm/fig1-accuracy-by-condition.png",
        caption:
          "Accuracy of frozen VLMs on A-OKVQA, ScienceQA, VCR and Causal-VidQA under the Textual Reliability Ladder. Across model families and scales, Option-Redirecting auxiliary text (brown) causes by far the largest drop relative to the No-Aux baseline, while other regimes barely move accuracy.",
      },
      {
        src: "/figures/option-redirecting-bias-vlm/fig2-mitigation-gains.png",
        caption:
          "Accuracy change (Δ, percentage points) from the training-free NSS+DG intervention relative to the frozen base models. Gains are consistently largest exactly under Option-Redirecting text — up to +15.1 points — while changes under faithful and other conditions stay small.",
      },
    ]),
    pdfUrl: "",
    codeUrl: "",
    projectUrl: "",
    image: "/figures/option-redirecting-bias-vlm/fig1-accuracy-by-condition.png",
    featured: false,
    order: 4,
  },
  {
    ...
    venue: "TMLR",
    venueDetail: "Transactions on Machine Learning Research · Journal article",
    year: 2026,
    abstract: "",
    pdfUrl: "",
    codeUrl: "",
  ...
  {
    title: "Holistic Feature Fusion for Fine-Grained Pen Classification",
    authors:
      "Huy Nguyen Pham Gia, Dang Ngo Viet Tue, Hien Pham Duy, Bao Ta Cao Nguyen, Thuyen Tran Doan, Thanh Duc Ngo",
    venue: "MAPR",
    venueDetail:
      "MAPR 2026 · International Conference on Multimedia Analysis and Pattern Recognition",
    year: 2026,
    abstract:
  ...
  {
    title: "MGTE: A Modular Multi-Granularity Text Ensemble for Interactive Image Retrieval",
    authors: "Khiem Le, Bao Tran, Duy-Dinh Le, Thanh Duc Ngo",
    venue: "MAPR",
    venueDetail:
      "MAPR 2026 · International Conference on Multimedia Analysis and Pattern Recognition",
    year: 2026,
  ...
  {
    title: "Track-Level Aggregation for Low-Resolution License Plate Recognition",
    authors:
  ...
  },
  {
    ...
    authors: "Hien Pham Duy, Bao Tran, Tien Do, Duy-Dinh Le, Thanh Duc Ngo",
    venue: "MAPR",
    venueDetail:
      "MAPR 2026 · International Conference on Multimedia Analysis and Pattern Recognition",
    year: 2026,
    abstract:
      "Passage-based top-view person re-identification matches individuals across short overhead walking videos — a privacy-preserving setting where elevated cameras suppress facial and body-part cues and models are prone to scene shortcuts from floors, ramps and doorways. We propose a compact scene-agnostic RGB framework centered on segmentation-guided human-aware augmentation, which uses pedestrian masks during training to weaken background reliance and encourage person-centered descriptors. A single-branch Vision Transformer is trained with Circle-based discriminative supervision, and descriptor-consistency frame selection is applied before passage-level aggregation at inference. Under the official ICPR 2026 TVRID RGB-track protocol the method ranks first across the public and private scenarios, substantially outperforming the organizer's RGB baseline; it also reaches 94.7% Rank-1 and 87.2% mAP on Market-1501.",
    pdfUrl: "",
    codeUrl: "",
    projectUrl: "",
    featured: false,
  ...
  },
  {
    ...
    authors: "Thuyen Tran Doan, Tien Do, Thanh Duc Ngo",
    venue: "MAPR",
    venueDetail:
      "MAPR 2026 · International Conference on Multimedia Analysis and Pattern Recognition",
    year: 2026,
